...
namespace EquilibriumCore.Controllers
{
    ...
    public class ArmorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,ArmorPhysical,ArmorMagical,Special")] Armors armors)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,ArmorPhysical,ArmorMagical,Special")] Armors armors)
        {
            if (id != armors.ID)
            {
                return NotFound();
